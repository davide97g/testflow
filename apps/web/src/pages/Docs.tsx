        ...
        <Tabs defaultValue="commands" className="space-y-8">
          ...
          <TabsContent value="commands" className="space-y-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  Interactive CLI wizard to set up testflow configuration.
                  Configures Bitbucket, Jira, and Confluence integrations, and
                  creates AI editor rule files.
                </p>
                ...
                <div className="space-y-2">
                  ...
                  <ul className="text-sm text-muted-foreground list-disc list-inside space-y-1 ml-2">
                    ...
                    <li>
                      Sets up AI editor rules (Cursor, GitHub Copilot, Codeium)
                    </li>
                  </ul>
                </div>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  Extract Jira issue data, linked resources, and PR changes. Can
                  be used interactively or with a specific issue key.
                </p>
                ...
                <div className="space-y-2">
                  ...
                  <ul className="text-sm text-muted-foreground list-disc list-inside space-y-1 ml-2">
                    ...
                    <li>
                      Extracts linked resources (other Jira issues and
                      Confluence pages)
                    </li>
                    <li>Fetches Confluence page content (if configured)</li>
                    <li>
                      Searches for associated Bitbucket branches and PRs (if
                      configured)
                    </li>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <ul className="text-sm text-muted-foreground list-disc list-inside space-y-1 ml-2">
                    <li>
                      <code className="px-1 py-0.5 bg-muted rounded">prId</code>{" "}
    ...
    └── page-{ID}.txt`}
            ...
            <Card>
              <CardHeader>
                <CardTitle>
                  <code className="text-lg font-mono">
                    jira-issue-description.txt
                  </code>
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  Human-readable summary of the Jira issue, formatted for easy
                  consumption by AI editors.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  Complete Jira issue data in JSON format, including all fields,
            ...
            <Card>
              <CardHeader>
                <CardTitle>
                  <code className="text-lg font-mono">
                    raw/linked-resources.json
                  </code>
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  List of all linked Jira issues and Confluence pages associated
                  with the main issue.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  Git patch file containing all code changes from the associated
          ...
          <TabsContent value="integration" className="space-y-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  testflow seamlessly integrates with AI-powered editors to
                  provide intelligent context about Jira issues and PR changes.
                </p>
                ...
                <div className="space-y-6 mt-6">
                  <div>
                    ...
                    <p className="text-muted-foreground mb-3">
                      The init command automatically creates a{" "}
                      <code className="px-1 py-0.5 bg-muted rounded">
                        .cursorrules
                      </code>{" "}
                      file with testflow instructions. AI assistants can read
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground mb-3">
                      ...
                      file. GitHub Copilot can reference the extracted issue
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground mb-3">
                      ...
                      file. Codeium can access the structured output in{" "}
                      <code className="px-1 py-0.5 bg-muted rounded">
                        .testflow/output/
                      </code>
                      .
